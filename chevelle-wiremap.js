  ...
  'aaw-sheet': {
    ...
    pins: [
      ...
      { id: 'aaw-4',  part: 'Rear Body',                      x: 1370, y: 585, verdict: 'connect',
        info: 'Mates the Bag M rear harness: TAN fuel sender (continues to HDX FUEL input), BROWN tail, YELLOW LH turn/brake, DK GREEN RH turn/brake, LT GREEN backup. CAP its ORANGE + WHITE (dome/courtesy) and LT BLUE (no third brake light).' },
      { id: 'aaw-5',  part: 'Instrument Cluster Disconnects', x: 1525, y: 120, verdict: 'harvest',
        info: 'Factory-cluster plugs — connect to NOTHING. HARVEST 4 wires to the HDX box: LT BLUE → LEFT(+), DK BLUE → RIGHT(+), LT GREEN thin → HIGH(+), TAN → BRAKE(−). CAP the rest: DK BLUE oil, DK GREEN temp, TAN fuel, WHITE tach, BROWN alt, YELLOW clock, Connector G PINK/GREY/BLACK, all of Connector H. Three TANs live here — identify by cavity (Bag H diagrams), not color.' },
